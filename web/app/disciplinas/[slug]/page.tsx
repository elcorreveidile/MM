...
const disciplinasData: Record<string, DisciplinaData> = {
  ...
  cine: {
    ...
    descripcion: 'El cine fue para Maresca una forma de pensamiento. Organizó ciclos de cine en Granada y publicó crítica cinematográfica en Olvidos de Granada. La biblioteca de cine —en torno a 50 títulos, más una extensa colección de DVDs agrupados en varias cajas— refleja una cinefilia de gran amplitud y profundidad. Pasolini ocupa un lugar central y tiene su propia caja dedicada: decenas de libros, revistas y documentos de trabajo, entre ellos el catálogo de sus pinturas y los materiales de producción de Saló: el infierno según Pasolini (Filmoteca Andalucía, 1993), que Maresca coeditó con Juan Ignacio Mendiguchía. Fritz Lang tiene asimismo una caja entera: más de quince monografías y dos colecciones de DVDs sobre su obra completa. A estos núcleos se añaden Fassbinder, Visconti, Truffaut, Bergman, Kubrick, Orson Welles, Buñuel, Coppola, Clint Eastwood, Almodóvar y Woody Allen.',
    libros: {
      total: 49,
      secciones: [
