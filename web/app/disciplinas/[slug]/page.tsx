...
const disciplinasData: Record<string, DisciplinaData> = {
  ...
  cine: {
    ...
    descripcion: 'El cine fue para Maresca una forma de pensamiento que vivió con intensidad compartida: en las salas, en las proyecciones del cine-club universitario, en su propia casa —donde no era raro que se reunieran dos o tres amigos a ver una película—, o en festivales cuya creación empujó antes incluso de que existieran, como el Festival de Cine del Sur, nacido de la mano de José Sánchez-Montes, con quien le unía una larga y honda amistad. Publicó crítica cinematográfica en Olvidos de Granada. La biblioteca de cine —en torno a 50 títulos, más una extensa colección de DVDs agrupados en varias cajas— refleja una cinefilia de gran amplitud y profundidad. Pasolini ocupa un lugar central y tiene su propia caja dedicada: decenas de libros, revistas y documentos de trabajo, entre ellos el catálogo de sus pinturas y los materiales de producción de Saló: el infierno según Pasolini (Filmoteca Andalucía, 1993), que Maresca coeditó con Juan Ignacio Mendiguchía. Fritz Lang tiene asimismo una caja entera: más de quince monografías y dos colecciones de DVDs sobre su obra completa. A estos núcleos se añaden Fassbinder, Visconti, Truffaut, Bergman, Kubrick, Orson Welles, Buñuel, Coppola, Clint Eastwood, Almodóvar y Woody Allen.',
    libros: {
      total: 49,
      secciones: [
        ...
        { nombre: 'Otros directores', autores: 'Rainer W. Fassbinder · Luchino Visconti · François Truffaut · Ingmar Bergman · Stanley Kubrick · Orson Welles · Luis Buñuel · Francis Ford Coppola · Clint Eastwood · Pedro Almodóvar · Woody Allen · Jean-Luc Godard · John Cassavetes' },
  ...
  musica: {
    ...
    descripcion: 'La música atravesó toda la vida cultural de Maresca. Publicó crítica musical en Olvidos de Granada y siguió de cerca la música flamenca —el célebre disco Omega de Enrique Morente tiene un lugar destacado en su biblioteca—. El tango le interesó como fenómeno cultural y político: redactó las bases del concurso de letras que dio lugar al libro colectivo Granada Tango (1982), editado por La Tertulia, y presentó el libro junto a Horacio Rébora y Juan Carlos Rodríguez en el Ayuntamiento de Granada. Su biblioteca musical —una de las más reveladoras de su carácter— incluye monografías sobre Wagner (dos biografías), Mozart, Mahler, Debussy, Beethoven, Verdi, Stravinsky, Bach, Glenn Gould y Chet Baker, junto al CD de Omega y el libro Universo Morente.',
    libros: {
      secciones: [
