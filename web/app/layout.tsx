...
export const metadata: Metadata = {
  ...
  description: "Exposición homenaje a Mariano Maresca, editor de Olvidos de Granada. Biblioteca de la Facultad de Derecho. Asociación Cultural Olvidos de Granada.",
  openGraph: {
    title: 'Mariano Maresca - Memoria viva de la cultura granadina',
    description: 'Exposición homenaje a Mariano Maresca, editor de Olvidos de Granada. Biblioteca de la Facultad de Derecho. Asociación Cultural Olvidos de Granada.',
