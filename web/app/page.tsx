            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-zinc-600 leading-relaxed font-libre">
                  Años después llegaría el <strong>café Botánico</strong>, en la calle Duquesa —al lado de la Facultad—, donde Mariano iba a comer, a tomar algo, a quedarse un rato. Amigos de distintos mundos sabían que podían encontrarle allí. A menudo la jornada terminaba en La Tertulia al caer la noche.
                </p>
              </div>
