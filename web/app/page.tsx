      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-200">
            {[
              { title: 'Granada Tango', year: '1982', description: 'Escribió las letras de tango publicadas en este libro, resultado de un concurso celebrado en La Tertulia. También colaboró en el diseño del cartel de alguna edición del Festival de Tango de Granada.', category: 'Música' },
