          ...
          <div className="lg:col-span-2 bg-white divide-y divide-zinc-100">
            ...
            <section className="p-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-zinc-700 leading-relaxed font-libre">
                  Más tarde, el <strong>café Botánico</strong> —calle Duquesa, al lado de la Facultad— se convirtió en otro lugar habitual: iba a comer, a veces a cenar o a tomar algo, y amigos de distintos mundos sabían que podían acercarse a encontrarle allí. A menudo la jornada terminaba pasando por alguna librería y acabando en La Tertulia.
                </p>
              </div>
            </section>
